{
    ...
    function DescEmp(inpempresa:string, inpdescServicio:string) {
       
              
          let bandera:string
          bandera=''
          
          for(let clave in corridasWeb){
            if (corridasWeb[clave].empresa==inpempresa )
                {
                    bandera='SI'
                    console.log('Corrida:'+ corridasWeb[clave].numeroCorrida); 
                    console.log('Descripcion Servicio: '+corridasWeb[clave].descripcionServicio); 
                    console.log('Empresa:'+ corridasWeb[clave].empresa); 
                    console.log('Descripción Empresa: '+corridasWeb[clave].descripcionEmpresa); 
                    console.log(`Descuentos: ${corridasWeb[clave].listaDescuentos ? true:false} `);
                    console.log('******************************************************');
                    
                }
                else if (corridasWeb[clave].descripcionServicio==inpdescServicio )
                {
                        
                        {
                            console.log('Corrida:'+ corridasWeb[clave].numeroCorrida); 
                            console.log('Descripcion Servicio: '+corridasWeb[clave].descripcionServicio); 
                            console.log('Empresa: AEF'); 
                            console.log('Descripción Empresa: '+corridasWeb[clave].descripcionEmpresa); 
                            console.log(`Descuentos: ${corridasWeb[clave].listaDescuentos ? true:false} `);
                            console.log('******************************************************');
                        }   
    ...
    let emp:string;
    let desServ:string;
    emp = prompt('Nombre de la empresa:');
    desServ = prompt('DEscripción del servicio:');
    console.log(DescEmp(emp, desServ));
